...
clash_proxy_path = os.path.join(os.environ['HOME'], "clashproxy")
os.makedirs(clash_proxy_path, exist_ok=True, mode=0o775)
conf["LOG_HOME"] = clash_proxy_path
...
errorlog = os.path.join(clash_proxy_path, "gunicorn_error.log")
...
accesslog = os.path.join(clash_proxy_path, "gunicorn_access.log")
...
gunicorn_access_logger.info(f"clash_proxy_path: {clash_proxy_path}")
